...
public class ColumnWriteStoreV1 implements ColumnWriteStore {
  ...
  public ColumnWriteStoreV1(PageWriteStore pageWriteStore, int pageSizeThreshold,
                            int dictionaryPageSizeThreshold, boolean enableDictionary,
                            WriterVersion writerVersion, String[] dictionaryExcludeColumns) {
    super();
  ...
  private ColumnWriterV1 newMemColumn(ColumnDescriptor path) {
    ...
    return new ColumnWriterV1(path, pageWriter, pageSizeThreshold, dictionaryPageSizeThreshold, enableDictionary, writerVersion, dictionaryExcludeColumns);
  }
